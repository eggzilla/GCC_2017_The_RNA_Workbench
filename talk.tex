...
\frame{
  ...
  \begin{figure}
    ...
    \only<2>{\includegraphics[width=0.5\textwidth]{figures/welcome_image_2.eps}}
    \only<3>{\includegraphics[width=0.5\textwidth]{figures/welcome_image_3.eps}}
    \only<4>{\includegraphics[width=0.5\textwidth]{figures/welcome_image_4.eps}}
    \only<5>{\includegraphics[width=0.5\textwidth]{figures/welcome_image_5.eps}}
    \only<6>{\includegraphics[width=0.5\textwidth]{figures/welcome_image.eps}}
  \end{figure}
  %% \begin{itemize}
  %% \item<2-> Comprehensive set of RNA-bioinformatics tools
  %% \item<3-> Easy and stable dissemination via Galaxy and Docker
  %% \item<4-> Set of predefined workflows and associated descriptions/training material
  %% \item<5-> Community - authors and users
  %%\end{itemize}
}
