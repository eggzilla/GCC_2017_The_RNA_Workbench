...
\frame{
  \frametitle{Community}
   ...
   \begin{figure}
     \centering
     \only<1>{\includegraphics[width=\textwidth]{figures/ncRNAworkflows_simplified.eps}}
     \only<2>{\includegraphics[width=\textwidth]{figures/ncRNAworkflows_simplified_1.eps}}
     \only<3>{\includegraphics[width=\textwidth]{figures/ncRNAworkflows_simplified_2.eps}}
     \only<4>{\includegraphics[width=\textwidth]{figures/ncRNAworkflows_simplified_3.eps}}
     \only<5>{\includegraphics[width=\textwidth]{figures/ncRNAworkflows_simplified_4.eps}}
  \end{figure}
 %%  \begin{itemize}
...
\frame{
  ...
  %using the workbench
  \begin{itemize}
  \item<5-> docker run -d -p 8080:80 bgruening/galaxy-rna-workbench
  \item<6-> OSX and Windows using the graphical tool Kitematic 
  \end{itemize}  
}
