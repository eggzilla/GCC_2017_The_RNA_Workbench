...
\frame{
  \frametitle{Workflow - \RNA{} family model construction}
  \begin{itemize}
  \item RNA family model construction
  \end{itemize}
   \begin{figure}
     \centering
    \only<1>{\includegraphics[width=0.8\textwidth]{figures/modelconstruction_workflow_1.eps}}
    \only<2>{\includegraphics[width=0.8\textwidth]{figures/modelconstruction_workflow_2.eps}}
    \only<3>{\includegraphics[width=0.8\textwidth]{figures/modelconstruction_workflow_3.eps}}
    \only<4>{\includegraphics[width=0.8\textwidth]{figures/modelconstruction_workflow_4.eps}}
  \end{figure}
